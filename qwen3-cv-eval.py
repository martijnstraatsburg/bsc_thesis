...
from sklearn.metrics import accuracy_score, precision_recall_fscore_support, mean_squared_error, cohen_kappa_score
import copy
...
class CrossValidationEvaluator:
    ...
    def create_summary_plots(self, all_results: Dict[str, Any]):
        ...
        for metric in metrics:
            ...
            rects = ax.bar(x + offset, means, width, label=metric.capitalize(), yerr=stds)
            multiplier += 1
