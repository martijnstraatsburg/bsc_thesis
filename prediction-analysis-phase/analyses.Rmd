...
ORs_i1 <- exp(coef(model_inter2))
CIs_i1 <- exp(confint(model_inter2))
knitr::kable(
  cbind(OR = ORs_i1, CI_low = CIs_i1[,1], CI_high = CIs_i1[,2]),
  digits = 3,
  caption = "Odds Ratios & 95% CI, Interaction Model 1"
...
anova_tab <- anova(
  model_base, model_inter1, model_inter2,
  test = "Chisq"
)
knitr::kable(
  anova_tab,
  digits = c(NA, 0, 3, 3, 3),
  caption = "Likelihood‐Ratio Tests: Base vs. Interaction Models"
)
```
